...
public class HistoryActivity extends AppCompatActivity {
    ...
    private List<historydata> persons;
    private RecyclerView rv;
    SharedPreferences myPref;
    private ListView historylist;
    public String url = "http://192.168.0.5:51444//api/useracc/gethistory";
    private String id;
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    for (int i = 0; i <array.length(); i++) {
                        ...
                        persons.add(new historydata(jsonObj.getString("driverph"),
                                jsonObj.getString("dept"),
                                jsonObj.getString("drivername"),
                                jsonObj.getString("branchname")
                                ));
